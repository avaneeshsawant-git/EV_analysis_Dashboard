...
# =========================================================
# TAB 1 — MARKET TRENDS (ADDED SCATTER)
# =========================================================
with tab1:
    ...
    fig_scatter = px.scatter(
        ...
        labels={
            "ice": "ICE Registrations",
            "ev": "EV Registrations"
        }
    )
    fig_scatter.update_layout(plot_bgcolor="#f3f4fb", paper_bgcolor="#f3f4fb")
    st.plotly_chart(fig_scatter, use_container_width=True)

    st.info(
        "The scatter plot highlights the substitution effect: "
        "as EV registrations rise, ICE registrations tend to decline."
    )
...
# =========================================================
# TAB 3 — DRIVERS & POLICY (FIXED & GUARANTEED)
# =========================================================
# =========================================================
...
with tab3:
    ...
    fig_base.update_layout(
        plot_bgcolor="#f3f4fb",
        paper_bgcolor="#f3f4fb"
    )
    st.plotly_chart(fig_base, use_container_width=True)

    st.info(
        "This chart shows how EV adoption scales with overall vehicle market size. "
        "Some smaller states achieve high EV penetration despite lower total volumes, "
        "indicating policy or urban-driven adoption."
    )
...
# =========================================================
# TAB 5 — FORECAST (YEAR SELECTOR ADDED)
# =========================================================
with tab5:
    ...
    if len(fdf) > 1:
        ...
        # Line forecast
        future = pd.DataFrame({"year": range(min_year, max_year + 1)})
